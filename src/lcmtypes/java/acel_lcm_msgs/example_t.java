...
public final class example_t implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(acel_lcm_msgs.example_t.class))
            return 0L;
 
        classes.add(acel_lcm_msgs.example_t.class);
    ...
    public static acel_lcm_msgs.example_t _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        acel_lcm_msgs.example_t o = new acel_lcm_msgs.example_t();
    ...
    public acel_lcm_msgs.example_t copy()
    {
        acel_lcm_msgs.example_t outobj = new acel_lcm_msgs.example_t();
