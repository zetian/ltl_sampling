...
public:
    ...
    static bool collision_check_multi_dubins(std::vector<DubinsPath::PathData> multi_dubins_steer_data, std::vector<Region> obstacle, double work_space_size_x, double work_space_size_y);
