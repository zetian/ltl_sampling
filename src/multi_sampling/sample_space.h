...
public:
    ...
    void rewire_dubins(int num_agent, uint64_t rewire_sample_id, int rewire_sample_ba, std::vector<Region> obstacles, double work_space_size_x, double work_space_size_y, double RADIUS, double min_radius, double path_step);
};